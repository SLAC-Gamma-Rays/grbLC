    ...
    if sum(df["time_sec"] <= 0) == 0:
        ...
        if guess is not False:
            ...
            try:
                ...
                plot_w07_fit(xdata, ydata, p, tt=guess[-1], logTerr=None, logFerr=known_yerr, guess=guess)
            ...
            try:
                p, pcov, guess = fit_w07(
                    xdata, ydata, logTerr=None, logFerr=known_yerr, return_guess=True, maxfev=10000
                )
