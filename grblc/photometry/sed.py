...
def _beta_marquardt(
    ...
    """
    Function to fit the Spectral Energy Distribution following the Equation 3 of Dainotti et al (2024): 
                                                                        https://arxiv.org/pdf/2405.02263
    ...
    if len(df) != 0:
        ...
        for i in iters:
            ...
            if len(set(filters_list)) > 3:
                ...
                # 26feb commented
                if abs(slopeerr) > abs(slope) or slopeerr is None:
                    reject_plot = True
