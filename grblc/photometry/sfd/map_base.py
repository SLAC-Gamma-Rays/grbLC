...
#
# This file has been modified by S. Young to remove all functions using
# the `healpix` package. This is to allow querying the SFD map on Windows
# machines.
#
import inspect
import json
...
class DustMap:
    ...
    def query_equ(self, ra, dec, d=None, frame='icrs', **kwargs):
        ...
        if frame not in valid_frames:
            raise ValueError(
                f'`frame` not understood. Must be one of {valid_frames}.')
